					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="alert alert-warning">
								<strong>Rinvex Fort default layout view!</strong> This view: <code>rinvex.fort.common.layout-example</code> is a default layout to show Rinvex features. It is extending: <code>rinvex.fort.common.layout</code> and the extended template needs overriding.
							</div>
							
							<h4>Publish Resources</h4>
							<p>
								To correctly display this view in your own blade layout then you need to publish this package's resources as follows (if you haven't already):
							</p>
							<hr/>
							<code>
							...
							<hr/>
							<p>
								Then open <code>"resources/views/vendor/rinvex/fort/common/layout.blade.php"</code> and change the extended layout view to the layout view you are using in your app eg:
								<code>"layouts.app"</code>. See <a href="https://laravel.com/docs/5.3/blade#extending-a-layout" target="_blank">Laravel Docs on Extending A Layout</a> for more info.
							</p>
						</div>
