...
<html lang="en">
    <head>
        ...
        <title>@section('title') {{ config('app.name', 'Rinvex Fort') }} @show</title>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                Then open
                                <code>"resources/views/vendor/rinvex/fort/frontend/common/layout.blade.php"</code> and change the extended layout view to the layout view you are using in your app eg:
