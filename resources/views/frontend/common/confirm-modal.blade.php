    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>{{ trans('rinvex/fort::frontend/forms.common.warning') }}:</strong> <span class="warning"></span>
            </div>
            <div class="modal-footer">
                {{ Form::open(['id' => 'delete-item-form', 'method' => 'delete']) }}
                    {{ Form::hidden('confirm', true) }}
                    {{ Form::button(trans('rinvex/fort::frontend/forms.common.close'), ['class' => 'btn btn-default', 'data-dismiss' => 'modal']) }}
...
@section('scripts')
    <script>
        $('#delete-confirmation').on('show.bs.modal', function (event) {
            ...
            var single_heading = '{{ trans('rinvex/fort::frontend/forms.sessions.flush_single_heading') }}';
            var single_body = '{!! trans('rinvex/fort::frontend/forms.sessions.flush_single_body') !!}';

            var all_heading = '{{ trans('rinvex/fort::frontend/forms.sessions.flush_all_heading') }}';
            var all_body = '{!! trans('rinvex/fort::frontend/forms.sessions.flush_all_body') !!}';
