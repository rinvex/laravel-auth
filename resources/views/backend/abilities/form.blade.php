                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                {{ Form::label('name', trans('rinvex/fort::backend/abilities.name'), ['class' => 'control-label']) }}
                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('rinvex/fort::backend/abilities.name'), 'required' => 'required', 'autofocus' => 'autofocus']) }}
