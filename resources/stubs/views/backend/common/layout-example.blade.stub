                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="alert alert-warning">
                                ...
                                <code>backend.common.layout</code> is extending a default stub layout
                                <code>backend.common.layout-example</code> which is a default layout to show
                            ...
                            <p>
                                Then open
                                <code>"resources/views/backend/common/layout.blade.php"</code> and change the extended layout view to the layout view you are using in your app eg:
