...
Route name: `rinvex.fort.auth.login` Route URI: `/auth/login`
...
Route name: `rinvex.fort.auth.logout` Route URI: `/auth/logout`
\Rinvex\Fort\Http\Controllers\AuthenticationController::logout

![Rinvex Fort - Logout](https://rinvex.com/assets/frontend/layout/img/products/rinvex-fort/logout.png)

### Register

Route name: `rinvex.fort.auth.register` Route URI: `/auth/register`
...
Route name: `rinvex.fort.account.page` Route URI: `/account/page`
...
Route name: `rinvex.fort.account.sessions` Route URI: `/account/sessions`
...
Route name: `rinvex.fort.account.sessions.flush` Route URI: `/account/sessions/flush/{token}`
\Rinvex\Fort\Http\Controllers\AccountController::processSessionFlush

### Flush All Active Sessions

Route name: `rinvex.fort.account.sessions.flushall` Route URI: `/account/sessions/flushall`
\Rinvex\Fort\Http\Controllers\AccountController::processSessionFlush
...
Route name: `rinvex.fort.account.twofactor.totp.enable` Route URI: `/account/twofactor/totp/enable`
...
Route name: `rinvex.fort.account.twofactor.totp.disable` Route URI: `/account/twofactor/totp/disable`
\Rinvex\Fort\Http\Controllers\AccountController::processTwoFactorTotpDisable

### Backup Two-Factor TOTP

Route name: `rinvex.fort.account.twofactor.totp.backup` Route URI: `/account/twofactor/totp/backup`
...
Route name: `rinvex.fort.account.twofactor.phone.enable` Route URI: `/account/twofactor/phone/enable`
\Rinvex\Fort\Http\Controllers\AccountController::processTwoFactorPhoneEnable

### Disable Two-Factor Phone

Route name: `rinvex.fort.account.twofactor.phone.disable` Route URI: `/account/twofactor/phone/disable`
\Rinvex\Fort\Http\Controllers\AccountController::processTwoFactorPhoneDisable

### Request Password Reset

Route name: `rinvex.fort.password.request` Route URI: `/password/request`
...
Route name: `rinvex.fort.password.reset` Route URI: `/password/reset`
...
Route name: `rinvex.fort.verification.email` Route URI: `/verification/email`
...
Route name: `rinvex.fort.verification.email.verify` Route URI: `/verification/email/verify`
\Rinvex\Fort\Http\Controllers\VerificationController::processEmailVerification

![Rinvex Fort - Email Verification](https://rinvex.com/assets/frontend/layout/img/products/rinvex-fort/email-verification.png)

### Request Phone Verification

Route name: `rinvex.fort.verification.phone` Route URI: `/verification/phone`
...
Route name: `rinvex.fort.verification.phone.verify` Route URI: `/verification/phone/verify`
