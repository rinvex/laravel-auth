...
class TwoFactorSettingsController extends AuthenticatedController
{
    ...
    public function updateTotp(TwoFactorTotpUpdateRequest $request, TwoFactorTotpProvider $totpProvider)
    {
        ...
        if ($totpProvider->verifyKey($secret, $request->get('token'))) {
            ...
            return intend([
                'back' => true,
                'with' => ['success' => trans('rinvex/fort::frontend/messages.verification.twofactor.totp.enabled')],
            ]);
        }
    ...
    public function disableTotp(TwoFactorTotpUpdateRequest $request)
    {
        ...
        return intend([
            ...
            'with'  => ['success' => trans('rinvex/fort::frontend/messages.verification.twofactor.totp.disabled')],
        ]);
    }
    ...
    public function enablePhone(TwoFactorPhoneUpdateRequest $request)
    {
        ...
        return intend([
            'route' => 'rinvex.fort.frontend.user.settings',
            'with'  => ['success' => trans('rinvex/fort::frontend/messages.verification.twofactor.phone.enabled')],
        ]);
    }
    ...
    public function disablePhone(TwoFactorPhoneUpdateRequest $request)
    {
        ...
        return intend([
            'route' => 'rinvex.fort.frontend.user.settings',
            'with'  => ['success' => trans('rinvex/fort::frontend/messages.verification.twofactor.phone.disabled')],
        ]);
    }
    ...
    public function backupTotp(TwoFactorTotpUpdateRequest $request)
    {
        ...
        return intend([
            'back' => true,
            'with' => ['success' => trans('rinvex/fort::frontend/messages.verification.twofactor.totp.rebackup')],
        ]);
    }
